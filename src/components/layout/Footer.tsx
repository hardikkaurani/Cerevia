...
export function Footer() {
  ...
  const navigation = {
    ...
    courses: [
      { label: 'Python for AI', href: '/lessons' },
      { label: 'Java Enterprise', href: '/lessons' },
      { label: 'React 19 & Next.js', href: '/lessons' },
      { label: 'Node.js Microservices', href: '/lessons' },
      { label: 'Cloud & Kubernetes', href: '/lessons' },
      { label: 'System Design', href: '/lessons' },
    ],
    resources: [
      { label: 'Documentation', href: '/docs' },
      { label: 'API Reference', href: '/api/docs' },
      { label: 'Community Forum', href: '/community' },
      { label: 'Student Perks', href: '/student-perks' },
    ],
    company: [
