    ...
    return (
      <div className="space-y-6 text-center z-10 relative max-w-md mx-auto w-full">
        ...
        <div className="space-y-2">
          <h3 className="text-2xl font-extrabold text-zinc-900 dark:text-white">Check Your Email</h3>
          <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
            We sent a password reset link to <span className="font-bold text-zinc-900 dark:text-white">{email}</span>. Click the link in the email to reset your password.
          </p>
        </div>
        ...
        <div className="pt-2 flex flex-col gap-3">
          <button 
            type="button"
            className="w-full h-11 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 text-xs font-semibold text-zinc-700 dark:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
          ...
          <Link 
            href="/login" 
            className="inline-flex items-center justify-center gap-2 text-xs font-semibold text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors"
          >
  ...
  return (
    <div className="flex flex-col gap-6 relative z-10 max-w-md mx-auto w-full">
      ...
      <div className="space-y-1.5 text-left">
        <div className="inline-flex items-center gap-1 text-[11px] font-bold text-amber-500 uppercase tracking-widest">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className={cn(
                'flex h-11 w-full rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/90 pl-10 pr-4 py-2 text-xs text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition-all duration-200 disabled:opacity-50'
              )}
            />
          </div>
        </div>
